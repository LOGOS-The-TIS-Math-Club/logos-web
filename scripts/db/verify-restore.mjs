...
try {
  ...
  try {
    ...
    const failures = [
      ...
      ["runtime may write images", p.runtime_images_insert],
      ["backup may read images", p.backup_images_select],
      ["runtime may write story entries", p.runtime_story_insert],
      ["backup may read story entries", p.backup_story_select],
      ["backup may NOT write story entries", !p.backup_story_insert],
