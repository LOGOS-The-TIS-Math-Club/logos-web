    ...
    database.transaction(async (transaction) => {
      ...
      const [application] = await transaction
        ...
        .values({
          ...
          mathCourse: parsedInput.mathCourse,
          contestInterest: parsedInput.contestInterest,
          presentInterest: parsedInput.presentInterest,
  ...
  return withDatabase(async (database) => {
    const [app] = await database
      .select({
        ...
        mathCourse: studentApplications.mathCourse,
        contestInterest: studentApplications.contestInterest,
        presentInterest: studentApplications.presentInterest,
        attendanceConfirmation: studentApplications.attendanceConfirmation,
